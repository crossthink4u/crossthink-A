    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="relative h-48 bg-gradient-to-r from-cyan-600/30 via-purple-600/30 to-blue-600/30 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10">
          <button onClick={() => router.push('/')} className="flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors px-3 py-1.5 rounded-full bg-black/30 backdrop-blur-md">
            ← Back
          </button>
          <button onClick={() => router.push('/dashboard')} className="flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors px-4 py-1.5 rounded-full bg-black/30 backdrop-blur-md">
