        ...
        <div className="rounded-2xl bg-white/[0.02] border border-white/[0.08] p-6 backdrop-blur-sm min-h-[380px] flex flex-col">
          ...
          <div className="flex gap-3 mt-6 pt-4 border-t border-white/[0.06]">
            ...
            {step === 5 && analysisComplete && (
              <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} onClick={() => navigate('/profile')}
          ...
          <p className="text-center text-xs text-gray-500 mt-4">
            Already have an account? <button onClick={() => navigate('/login')} className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">Sign In</button>
          </p>
        </div>
      </motion.div>
    </div>
