  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <h1 className="font-display text-3xl font-bold text-white mb-3">Stories</h1>
        <p className="text-gray-400 mb-8">
          Share your project journey, write about your learnings, and inspire others. Publishing tools are on the way.
        </p>
        <button
          onClick={() => router.push('/')}
